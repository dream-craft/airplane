      ...
      return (
        <div className={styles.container}>
          ...
          <p>
            ...
            <br />
            Failed to fetch data (mockServerId={mockServerId})
          </p>
        </div>
      );
    } else {
      ...
      return (
        <div>
          ...
          <div>
            ...
            {httpMock ? <Descriptions layout="vertical" bordered items={httpMockItems} /> : <NoAccess />}
            <p className={styles.header2}>WebSocket Mock Server</p>
            {wsMock ? <p>This content will be rendered if the condition is true.</p> : <NoAccess />}
          </div>
        </div>
      );
    }
